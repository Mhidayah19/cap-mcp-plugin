...
When a subscriber accesses your application through their approuter URL (e.g., `xba-dev-eu10.dev.mymediset.cloud`), the plugin automatically:
...
|----------|-------------|---------|
| `appDomain` | Application domain for tenant routing | `dev.mymediset.cloud` |
| `tenantSeparator` | Separator between subdomain and domain | `.` (default) |
| `XSAPPNAME` | XSUAA app name (used for subdomain stripping) | `mymediset-dev!t499687` |
